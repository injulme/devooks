...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center border-b-2 text-muted-foreground',
      className,
    )}
    {...props}
  />
